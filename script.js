...
const askAi = async (question, game, apiKey) => {
    ...
    ## Regras
    - Se você não sabe a resposta, responda com 'Não sei' e não tente inventar uma resposta. Porém dê dicas que combinem com o contexto (ex: você pode pesquisar no google, etc)
